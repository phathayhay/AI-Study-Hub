                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <h3 style={{ fontSize: '26px', fontWeight: 700, color: '#0f172a', textAlign: 'center', maxWidth: '85%', margin: 0 }}>{card.frontContent}</h3>
                    ...
                    >
                      ...
                      <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a', textAlign: 'center', maxWidth: '85%', margin: 0 }}>{card.backContent}</h3>
  ...
  return (
    <section>
      ...
      {cards.length > 0 ? (
        ...
        >
          ...
          >
            ...
            >
              <div style={{ position: 'absolute', top: '16px', left: '16px', fontSize: '12px', color: '#64748b', fontWeight: 500 }}>Mặt trước</div>
              ...
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a', textAlign: 'center', maxWidth: '80%' }}>{currentSliderCard.frontContent}</h3>
              <div style={{ position: 'absolute', bottom: '16px', fontSize: '12px', color: '#64748b' }}>Nhấp để lật thẻ</div>
            </div>
            ...
            >
              <div style={{ position: 'absolute', top: '16px', left: '16px', fontSize: '12px', color: '#64748b', fontWeight: 500 }}>Mặt sau</div>
              <div style={{ position: 'absolute', top: '16px', right: '16px', display: 'flex', gap: '12px', color: '#eab308' }}>
                <button 
                  onClick={(e) => toggleStar(currentSliderCard.id, e)} 
                  style={{ background: 'none', border: 'none', cursor: 'pointer', color: starredIds.has(currentSliderCard.id) ? '#eab308' : '#cbd5e1', fontSize: '16px' }}
              ...
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a', textAlign: 'center', maxWidth: '80%' }}>{currentSliderCard.backContent}</h3>
              <div style={{ position: 'absolute', bottom: '16px', fontSize: '12px', color: '#64748b' }}>Nhấp để lật thẻ</div>
            </div>
          </div>
        </div>
      ) : (
        <div style={{ minHeight: '340px', border: '1.5px dashed #cbd5e1', borderRadius: '16px', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', backgroundColor: '#f8fafc', padding: '32px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '20px' }}>
          <button 
            ...
            style={{ 
              ...
              transition: 'all 0.2s ease',
              boxShadow: index === 0 ? 'none' : '0 4px 10px rgba(99, 102, 241, 0.2)',
            }}
            onMouseEnter={(e) => {
              if (index !== 0) {
          ...
          >
            <StudyHubIcon name="arrow-left" size={16} />
          </button>

          <span style={{ fontSize: '15px', color: '#1e293b', fontWeight: 700, minWidth: '60px', textAlign: 'center' }}>
          ...
          <button 
            ...
            style={{ 
              ...
              transition: 'all 0.2s ease',
              boxShadow: index >= cards.length - 1 ? 'none' : '0 4px 10px rgba(99, 102, 241, 0.2)',
            }}
            onMouseEnter={(e) => {
          ...
          >
            <StudyHubIcon name="arrow-right" size={16} />
          </button>
        </div>
      </div>
      ...
      <div style={{ marginTop: '48px', borderTop: '1px solid #e2e8f0', paddingTop: '32px' }}>
        <h3 style={{ fontSize: '18px', fontWeight: 700, color: '#0f172a', marginBottom: '20px' }}>Chế độ học tập</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
          ...
          >
            <div>
              <span style={{ fontSize: '11px', fontWeight: 700, color: '#2563eb', textTransform: 'uppercase', tracking: '0.05em', backgroundColor: '#dbeafe', padding: '4px 8px', borderRadius: '12px' }}>Đang hoạt động</span>
              <h4 style={{ fontSize: '20px', fontWeight: 700, color: '#1e3a8a', marginTop: '12px', marginBottom: '8px' }}>Học từ mới</h4>
              <p style={{ fontSize: '13px', color: '#3b82f6', margin: 0 }}>Ghi nhớ từ vựng với thẻ thông minh.</p>
            </div>
            <div style={{ alignSelf: 'flex-end', fontSize: '32px' }}>📖</div>
          </div>
          ...
          >
            <div>
              <span style={{ fontSize: '11px', fontWeight: 700, color: '#16a34a', textTransform: 'uppercase', tracking: '0.05em', backgroundColor: '#dcfce7', padding: '4px 8px', borderRadius: '12px' }}>Đang hoạt động</span>
              <h4 style={{ fontSize: '20px', fontWeight: 700, color: '#14532d', marginTop: '12px', marginBottom: '8px' }}>Trò chơi ghép thẻ</h4>
              <p style={{ fontSize: '13px', color: '#16a34a', margin: 0 }}>Ghép nghĩa và từ nhanh nhất có thể.</p>
            </div>
            <div style={{ alignSelf: 'flex-end', fontSize: '32px' }}>🧩</div>
          </div>

          {/* Card 3: Kiểm tra từ mới */}
          <div 
            ...
            onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-4px)'; e.currentTarget.style.boxShadow = '0 8px 20px rgba(249, 115, 22, 0.15)' }}
            onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = '0 4px 12px rgba(249, 115, 22, 0.08)' }}
          >
            <div>
              <span style={{ fontSize: '11px', fontWeight: 700, color: '#ea580c', textTransform: 'uppercase', tracking: '0.05em', backgroundColor: '#ffedd5', padding: '4px 8px', borderRadius: '12px' }}>Đang hoạt động</span>
              <h4 style={{ fontSize: '20px', fontWeight: 700, color: '#7c2d12', marginTop: '12px', marginBottom: '8px' }}>Kiểm tra từ mới</h4>
              <p style={{ fontSize: '13px', color: '#ea580c', margin: 0 }}>Đánh giá khả năng thuộc từ của bạn.</p>
            </div>
            <div style={{ alignSelf: 'flex-end', fontSize: '32px' }}>🥷</div>
          </div>
