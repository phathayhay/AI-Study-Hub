              ...
              <>
                <div style={{ display: 'flex', gap: '10px', alignItems: 'center', flexWrap: 'wrap' }}>
                  <button
                    ...
                    className="bg-[#6366f1] hover:bg-indigo-700 text-white font-semibold transition-colors duration-200 disabled:opacity-70 disabled:cursor-not-allowed"
                    style={{ padding: '8px 18px', borderRadius: '8px', border: 'none', cursor: demoUpgrading || checking ? 'not-allowed' : 'pointer' }}
                    type="button"
                  >
                  ...
                  <button
                    ...
                    style={{ padding: '8px 18px', borderRadius: '8px', border: 'none', cursor: checking || demoUpgrading ? 'not-allowed' : 'pointer' }}
                    type="button"
                  >
