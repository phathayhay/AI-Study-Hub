...
- [x] Xây dựng luồng Đăng ký / Đăng nhập / Xác nhận email
- [x] Xây dựng trang Dashboard quản lý tài liệu & thư mục
- [x] Xây dựng giao diện xem tài liệu tích hợp AI (Summary, Quiz, Flashcard, Chatbot)
- [x] Xây dựng trang nâng cấp gói và cổng thanh toán
- [x] Xây dựng Dashboard cho Admin
